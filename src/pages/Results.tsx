...
import { ShieldCheck, Clock, AlertCircle, CheckCircle2, ArrowLeft, Share2, Download } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
        ...
        <div className="lg:col-span-7 space-y-8">
          ...
          >
            <div className="flex items-start justify-between mb-8">
              <div>
                ...
                <p className="text-text-secondary text-lg font-medium">Found on {result.leafType}</p>
              </div>
          ...
          <div className="flex flex-col sm:flex-row gap-5">
            <button className="flex-1 bg-deep-green text-white py-5 rounded-full font-bold text-xl shadow-xl hover:bg-muted-green transition-all active:scale-95">
              {t('saveHistory')}
            </button>
            <button className="flex-1 neumorphic-btn font-bold text-xl text-deep-green">
              {t('askHelp')}
            </button>
          </div>
        </div>
