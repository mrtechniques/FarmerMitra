...
export const translations: Translations = {
  ...
  scanAnother: { en: 'Scan Another Plant', hi: 'एक और पौधा स्कैन करें', kn: 'ಮತ್ತೊಂದು ಸಸ್ಯವನ್ನು ಸ್ಕ್ಯಾನ್ ಮಾಡಿ', ml: 'മറ്റൊരു ചെടി സ്കാൻ ചെയ്യുക' },
  askHelp: { en: 'Ask Agent for Help', hi: 'मदद के लिए एजेंट से पूछें', kn: 'सहायता के लिए एजेंट को बुलाएँ', ml: 'സഹായത്തിന് ഏജന്റിനോട് ചോദിക്കുക' },
  ...
  // New Status & Misc
  healthyPlant: { en: 'Healthy Plant', hi: 'स्वस्थ पौधा', kn: 'ಆರೋಗ್ಯಕರ ಸಸ್ಯ', ml: 'ആരോഗ്യമുള്ള ചെടി' },
  recoveryVaries: { en: 'Varies', hi: 'परिवर्तित होता है', kn: 'ಬದಲಾಗುತ್ತದೆ', ml: 'വ്യത്യാസപ്പെടുന്നു' },
  
  // Agent Quick Prompts
  diagPlant: { en: 'Diagnose my plant', hi: 'मेरे पौधे का निदान करें', kn: 'ನನ್ನ ಸಸ್ಯವನ್ನು ಪತ್ತೆ ಮಾಡಿ', ml: 'എന്റെ ചെടി രോഗനിർണ്ണയം ചെയ്യുക' },
  waterTips: { en: 'Watering tips', hi: 'सिंचाई के सुझाव', kn: 'ನೀರುಹಾಕುವ ಸಲಹೆಗಳು', ml: 'നനയ്ക്കാനുള്ള നുറുങ്ങുകൾ' },
  soilHealth: { en: 'Soil health', hi: 'मिट्टी का स्वास्थ्य', kn: 'ಮಣ್ಣಿನ ಆರೋಗ್ಯ', ml: 'മണ്ണിലെ ആരോഗ്യം' },
  bestPractices: { en: 'Best practices', hi: 'सर्वोत्तम प्रथाएं', kn: 'ಉತ್ತಮ ಅಭ್ಯಾಸಗಳು', ml: 'മികച്ച രീതികൾ' },
  
  diagPlantQuery: { en: 'How do I identify what disease my plant has?', hi: 'मैं कैसे पहचानूँ कि मेरे पौधे को कौन सी बीमारी है?', kn: 'ನನ್ನ ಸಸ್ಯಕ್ಕೆ ಯಾವ ರೋಗವಿದೆ ಎಂದು ನಾನು ಹೇಗೆ ಗುರುತಿಸುವುದು?', ml: 'എന്റെ ചെടിക്ക് ഏത് രോഗമാണെന്ന് ഞാൻ എങ്ങനെ തിരിച്ചറിയും?' },
  waterTipsQuery: { en: 'How often should I water my crop?', hi: 'मुझे अपनी फसल को कितनी बार पानी देना चाहिए?', kn: 'ನಾನು ನನ್ನ ಬೆಳೆಗೆ ಎಷ್ಟು ಬಾರಿ ನೀರು ಹಾಕಬೇಕು?', ml: 'എന്റെ വിളയ്ക്ക് എത്ര തവണ നനയ്ക്കണം?' },
  soilHealthQuery: { en: 'How do I improve my soil health?', hi: 'मैं अपनी मिट्टी के स्वास्थ्य में कैसे सुधार करूँ?', kn: 'ನನ್ನ ಮಣ್ಣಿನ ಆರೋಗ್ಯವನ್ನು ನಾನು ಹೇಗೆ ಸುಧಾರಿಸುವುದು?', ml: 'എന്റെ മണ്ണിലെ ആരോഗ്യം എങ്ങനെ മെച്ചപ്പെടുത്താം?' },
  bestPracticesQuery: { en: 'What are the best practices for preventing plant diseases?', hi: 'पौधों की बीमारियों को रोकने के लिए सर्वोत्तम प्रथाएं क्या हैं?', kn: 'ಸಸ್ಯ ರೋಗಗಳನ್ನು ತಡೆಗಟ್ಟಲು ಉತ್ತಮ ಅಭ್ಯಾಸಗಳು ಯಾವುವು?', ml: 'സസ്യരോഗങ്ങൾ തടയുന്നതിനുള്ള മികച്ച രീതികൾ ഏതാണ്?' },
  
  // Scan Validation
  checkingQuality: { en: 'Checking image quality...', hi: 'छवि की गुणवत्ता की जाँच की जा रही है...', kn: 'ಚಿತ್ರದ ಗುಣಮಟ್ಟವನ್ನು ಪರಿಶೀಲಿಸಲಾಗುತ್ತಿದೆ...', ml: 'ചിത്രത്തിന്റെ ഗുണനിലവാരം പരിശോധിക്കുന്നു...' },
  detectingLeaf: { en: 'Detecting leaf and measuring sharpness', hi: 'पत्ती का पता लगाना और तीक्ष्णता मापना', kn: 'ಎಲೆಯನ್ನು ಪತ್ತೆಹಚ್ಚುವುದು ಮತ್ತು ತೀಕ್ಷ್ಣತೆಯನ್ನು ಅಳೆಯುವುದು', ml: 'ഇല കണ്ടെത്തുകയും മൂർച്ച അളക്കുകയും ചെയ്യുന്നു' },
  noLeafTitle: { en: 'No Leaf Detected', hi: 'कोई पत्ती नहीं मिली', kn: 'ಯಾವುದೇ ಎಲೆ ಪತ್ತೆಯಾಗಿಲ್ಲ', ml: 'ഇലയൊന്നും കണ്ടെത്തിയില്ല' },
  noLeafSub: { en: 'The uploaded image does not appear to contain a plant leaf. Please upload a clear photo of a leaf for accurate disease detection.', hi: 'अपलोड की गई छवि में पौधे की पत्ती नहीं दिख रही है। कृपया सटीक रोग पहचान के लिए पत्ती की स्पष्ट फोटो अपलोड करें।', kn: 'ಅಪ್‌ಲೋಡ್ ಮಾಡಿದ ಚಿತ್ರವು ಸಸ್ಯದ ಎಲೆಯನ್ನು ಹೊಂದಿರುವಂತೆ ಕಂಡುಬರುತ್ತಿಲ್ಲ. ನಿಖರವಾದ ರೋಗ ಪತ್ತೆಗಾಗಿ ದಯವಿಟ್ಟು ಎಲೆಯ ಸ್ಪಷ್ಟ ಫೋಟೋವನ್ನು ಅಪ್‌ಲೋಡ್ ಮಾಡಿ.', ml: 'അപ്‌ലോഡ് ചെയ്ത ചിത്രത്തിൽ സസ്യത്തിന്റെ ഇല ഉള്ളതായി കാണുന്നില്ല. കൃത്യമായ രോഗനിർണ്ണയത്തിനായി ഒരു ഇലയുടെ വ്യക്തമായ ഫോട്ടോ അപ്‌ലോഡ് ചെയ്യുക.' },
  blurryTitle: { en: 'Image Too Blurry', hi: 'छवि बहुत धुंधली है', kn: 'ಚಿತ್ರವು ತುಂಬಾ ಮಸುಕಾಗಿದೆ', ml: 'ചിത്രം വളരെ മങ്ങിയതാണ്' },
  blurrySub: { en: 'Your image is too blurry for a reliable diagnosis.', hi: 'आपकी छवि विश्वसनीय निदान के लिए बहुत धुंधली है।', kn: 'ವಿಶ್ವಾಸಾರ್ಹ ರೋಗನಿರ್ಣಯಕ್ಕಾಗಿ ನಿಮ್ಮ ಚಿತ್ರವು ತುಂಬಾ ಮಸುಕಾಗಿದೆ.', ml: 'വിശ്വസനീയമായ രോഗനിർണ്ണയത്തിന് നിങ്ങളുടെ ചിത്രം വളരെ മങ്ങിയതാണ്.' },
  sharpnessScore: { en: 'Sharpness Score', hi: 'तीक्ष्णता स्कोर', kn: 'ತೀಕ್ಷ್ಣತೆಯ ಸ್ಕೋರ್', ml: 'ഷാർപ്നസ് സ്കോർ' },
  minRequired: { en: 'Minimum required', hi: 'न्यूनतम आवश्यक', kn: 'ಕನಿಷ್ಠ ಅಗತ್ಯವಿದೆ', ml: 'കുറഞ്ഞത് ആവശ്യമാണ്' },
  noLeafTips: { en: 'Tips: Make sure the leaf fills most of the frame and the background is minimal.', hi: 'सुझाव: सुनिश्चित करें कि पत्ती फ्रेम के अधिकांश हिस्से को भरती है और पृष्ठभूमि न्यूनतम है।', kn: 'ಸಲಹೆಗಳು: ಎಲೆಯು ಫ್ರೇಮ್‌ನ ಹೆಚ್ಚಿನ ಭಾಗವನ್ನು ತುಂಬುತ್ತದೆ ಮತ್ತು ಹಿನ್ನೆಲೆ ಕಡಿಮೆಯಿದೆ ಎಂದು ಖಚಿತಪಡಿಸಿಕೊಳ್ಳಿ.', ml: 'നുറുങ്ങുകൾ: ഇല ഫ്രെയിമിന്റെ ഭൂരിഭാഗവും നിറയുന്നുണ്ടെന്നും പശ്ചാത്തലം കുറവാണെന്നും ഉറപ്പാക്കുക.' },
  blurryTips: { en: 'Tips: Hold your camera steady, ensure good lighting, and tap the leaf to focus before capturing.', hi: 'सुझाव: कैमरा स्थिर रखें, अच्छी रोशनी सुनिश्चित करें, और कैप्चर करने से पहले फोकस करने के लिए पत्ती पर टैप करें।', kn: 'ಸಲಹೆಗಳು: ಕ್ಯಾಮೆರಾವನ್ನು ಸ್ಥಿರವಾಗಿ ಹಿಡಿದುಕೊಳ್ಳಿ, ಉತ್ತಮ ಬೆಳಕನ್ನು ಖಚಿತಪಡಿಸಿಕೊಳ್ಳಿ ಮತ್ತು ಸೆರೆಹಿಡಿಯುವ ಮೊದಲು ಫೋಕಸ್ ಮಾಡಲು ಎಲೆಯ ಮೇಲೆ ಟ್ಯಾಪ್ ಮಾಡಿ.', ml: 'നുറുങ്ങുകൾ: ക്യാമറ നിശ്ചലമായി പിടിക്കുക, നല്ല വെളിച്ചം ഉറപ്പാക്കുക, പകർത്തുന്നതിന് മുമ്പ് ഫോക്കസ് ചെയ്യുന്നതിനായി ഇലയിൽ ടാപ്പുചെയ്യുക.' },
  uploadAnother: { en: 'Upload Another Image', hi: 'दूसरी छवि अपलोड करें', kn: 'ಮತ್ತೊಂದು ಚಿತ್ರವನ್ನು ಅಪ್‌ಲೋಡ್ ಮಾಡಿ', ml: 'മറ്റൊരു ചിത്രം അപ്‌ലോഡ് ചെയ്യുക' },
  tryAgain: { en: 'Try Again', hi: 'फिर से प्रयास करें', kn: 'ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಿ', ml: 'വീണ്ടും ശ്രമിക്കുക' },
  analysisFailed: { en: 'Analysis Failed', hi: 'विश्लेषण विफल रहा', kn: 'ವಿಶ್ಲೇಷಣೆ ವಿಫಲವಾಗಿದೆ', ml: 'വിശകലനം പരാജയപ്പെട്ടു' },
  ensureBackend: { en: 'Make sure the Python backend server is running.', hi: 'सुनिश्चित करें कि पायथन बैकएंड सर्वर चल रहा है।', kn: 'ಪೈಥಾನ್ ಬ್ಯಾಕೆಂಡ್ ಸರ್ವರ್ ಚಾಲನೆಯಲ್ಲಿದೆ ಎಂದು ಖಚಿತಪಡಿಸಿಕೊಳ್ಳಿ.', ml: 'പൈത്തൺ ബാക്കെൻഡ് സെർവർ പ്രവർത്തിക്കുന്നുണ്ടെന്ന് ഉറപ്പാക്കുക.' },
};
