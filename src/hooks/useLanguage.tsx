...
export const translations: Translations = {
  ...
  recRemedies: { en: 'Remedies & Prevention', hi: 'उपचार और बचाव', kn: 'ಪರಿಹಾರ ಮತ್ತು ತಡೆಗಟ್ಟುವಿಕೆ', ml: 'പരിഹാരങ്ങളും പ്രതിരോധവും' },
